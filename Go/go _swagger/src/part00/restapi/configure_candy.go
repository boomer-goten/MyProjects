...
//go:generate swagger generate server --target ../../part00 --name Candy --spec ../swagger/swagger.yml --principal interface{}

func configureFlags(api *operations.CandyAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.CandyAPI) http.Handler {
