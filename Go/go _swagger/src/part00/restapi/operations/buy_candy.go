...
// BuyCandyBadRequestBody buy candy bad request body http 400
//
...
// ContextValidate проверяет это тело покупки конфеты в зависимости от контекста, в котором оно используется.
