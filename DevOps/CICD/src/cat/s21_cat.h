...
#define SYMBOLS                                                                                              \
    {                                                                                                        \
        "^@", "^A", "^B", "^C", "^D", "^E", "^F", "^G", "^H", " $", "$", "^K", "^L", "^M", "^N", "^O", "^P", \
            ...
            "M-^@", "M-^A", "M-^B", "M-^C", "M-^D", "M-^E", "M-^F", "M-^G", "M-^H", "M-^I", "M-^J", "M-^K",  \
            "M-^L", "M-^M", "M-^N", "M-^O", "M-^P", "M-^Q", "M-^R", "M-^S", "M-^T", "M-^U", "M-^V", "M-^W",  \
            "M-^X", "M-^Y", "M-^Z", "M-^[", "M-^\\", "M-^]", "M-^^", "M-^_", "M- ", "M-!", "M-\"", "M-#",    \
            "M-$", "M-%", "M-&", "M-'", "M-(", "m-)", "M-*", "M-+", "M-,", "M--", "M-.", "M-/", "M-0",       \
            "M-1", "M-2", "M-3", "M-4", "M-5", "M-6", "M-7", "M-8", "M-9", "M-:", "M-;", "M-<",              \
            "M-=", "M->", "M-?", "M-@", "M-A", "M-B", "M-C", "M-D", "M-E", "M-F", "M-G", "M-H", "M-I",       \
            "M-J", "M-K", "M-L", "M-M", "M-N", "M-O", "M-P", "M-Q", "M-R", "M-S", "M-T", "M-U", "M-V",       \
            "M-W", "M-X", "M-Y", "M-Z", "M-[", "M-\\", "M-]", "M-^", "M-_", "M-`", "M-a", "M-b", "M-c",      \
