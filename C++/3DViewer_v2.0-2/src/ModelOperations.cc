...
//int main() {
//  s21::Model object;
//  string path = "test/piramida.obj";
//  object.ReadScene(path);
//  const vector<unsigned>& facets = object.get_facets();
//  const vector<float>& vertexes = object.get_vertexes();
//  // for (auto i : facets) {
//  //   std::cout << i << " ";
//  // }
//  // std::cout << "\n";
...
//  //   std::cout << i << "\n";
//  // }
//  // std::cout << object.get_count_vertexes() << std::endl;
//  object.move(-2, 0, 0);
//  for (auto i : vertexes) {
//    std::cout << i << "\n";
//  }
//  std::cout << object.get_count_vertexes() << std::endl;
//  // std::cout << object.get_count_facets() << std::endl;
//  // std::cout << object.get_state_info() << std::endl;
//  //   string path_2 = "test/2and.obj";
//  //   object.ReadScene(path_2);
//  //   vector<unsigned> facets_2 = object.get_facets();
//  //   vector<float> vertexes_2 = object.get_vertexes();
//  //   for (auto i : facets_2) {
//  //     std::cout << i;
//  //   }
//  //   std::cout << "\n";
//  //   for (auto i : vertexes_2) {
//  //     std::cout << i << "\n";
//  //   }
//  //   std::cout << object.get_count_vertexes() << std::endl;
//  //   std::cout << object.get_count_facets() << std::endl;
