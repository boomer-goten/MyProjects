...
TEST(S21Matrix, OperatorSubtractionAssignment1) {
...
TEST(S21Matrix, OperatorSubtractionAssignment2) {
...
TEST(S21Matrix, OperatorSubtractionAssignment3) {
  S21Matrix matrix_1(4, 4);
...
TEST(S21Matrix, OperatorSubtractionAssignment4) {
  S21Matrix matrix_1(4, 4);
  S21Matrix matrix_2(4, 4);
  for (int i = 0; i < 4; i++) {
    for (int j = 0; j < 4; j++) {
...
TEST(S21Matrix, OperatorSubtractionAssignment5) {
  S21Matrix matrix_1(4, 4);
  S21Matrix matrix_2(4, 4);
  for (int i = 0; i < 4; i++) {
    for (int j = 0; j < 4; j++) {
...
TEST(S21Matrix, OperatorSubtractionAssignment6) {
  S21Matrix matrix_1(4, 4);
  S21Matrix matrix_2(4, 4);
  for (int i = 0; i < 4; i++) {
    for (int j = 0; j < 4; j++) {
