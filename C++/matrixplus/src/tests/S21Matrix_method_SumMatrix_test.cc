...
TEST(S21Matrix, MethodSumMatrix1) {
...
TEST(S21Matrix, MethodSumMatrix2) {
...
TEST(S21Matrix, MethodSumMatrix3) {
  S21Matrix matrix_1(4, 4);
...
TEST(S21Matrix, MethodSumMatrix4) {
  S21Matrix matrix_1(4, 4);
  S21Matrix matrix_2(4, 4);
  for (int i = 0; i < 4; i++) {
    for (int j = 0; j < 4; j++) {
...
TEST(S21Matrix, MethodSumMatrix5) {
  S21Matrix matrix_1(4, 4);
  S21Matrix matrix_2(4, 4);
  for (int i = 0; i < 4; i++) {
    for (int j = 0; j < 4; j++) {
...
TEST(S21Matrix, MethodSumMatrix6) {
  S21Matrix matrix_1(4, 4);
  S21Matrix matrix_2(4, 4);
  for (int i = 0; i < 4; i++) {
    for (int j = 0; j < 4; j++) {
